...
/* 			#content {
		...
		<script type="text/javascript">
			...
			function show_email_text() {
				document.getElementById("edit-email-text").style.display = "none";
				document.getElementById("show-email-text").style.display = "block";
				document.getElementById("button-show-email-text").style.display = "none";
				document.getElementById("button-edit-email-text").style.display = "block";
				document.getElementById("button-save-email-text").disabled = true;
			}
			function edit_email_text() {
				...
				document.getElementById("button-edit-email-text").style.display = "none";
				document.getElementById("button-show-email-text").style.display = "block";
				document.getElementById("button-save-email-text").disabled = false;
			}
      //-->
		</script>
	</head>
